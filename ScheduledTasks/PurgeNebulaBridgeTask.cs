...
public sealed class PurgeNebulaBridgeTask(
    ILibraryManager libraryManager,
    ILogger<PurgeNebulaBridgeTask> log,
    NebulaBridgeManager manager
) : IScheduledTask
{
    public string Name => "WARNING: purge all Nebula Bridge items";
    public string Key => "PurgeNebulaBridgeTask";
    public string Description => "Removes all Nebula Bridge items (local items are kept)";
