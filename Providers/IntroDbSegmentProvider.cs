...
public class IntroDbSegmentProvider : IMediaSegmentProvider
{
    ...
    /// <inheritdoc />
    public string Name => "Nebula Bridge IntroDB";
    ...
    /// <inheritdoc />
    /// <remarks>
    /// New in Jellyfin 12. This provider reads segments from the IntroDB HTTP
    /// API and keeps no extracted per-item data on disk, so there is nothing to
    /// clean up.
    /// </remarks>
